    ...
    try {
        ...
        const session = await encrypt({
            ...
            ...(userType === 'teacher' && {
                ...
                contact: (user as TeacherUser).contact || phone
            }),
            ...(userType === 'admin' && {
                adminPrivileges: 'Yes',
                contact: phone
        ...
        // 5. Return a success response with user info (including phone/contact).
        return NextResponse.json({
            success: true,
            ...
            user: {
                ...
                userType: userType,
                phone: phone,
                contact: userType === 'teacher' ? (user as TeacherUser).contact || phone : phone
            }
        });
