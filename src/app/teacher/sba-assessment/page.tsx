...
export default function TeacherSBAAssessmentPage() {
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          <div className="flex justify-between items-center mb-6">
            <div>
              <h2 className="text-xl font-semibold text-gray-900 mb-2">Select a Class for SBA Assessment</h2>
              <p className="text-gray-600">Choose a class to view and manage SBA assessments</p>
            </div>
          </div>
        </div>
        ...
        {classes.length === 0 ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {classes.map((classData) => (
              <Link
                key={classData.name}
                href={`/teacher/sba-assessment/${encodeURIComponent(classData.name)}`}
