  ...
  try {
    const response = await fetch(`${FROG_API_BASE_URL}/sms/otp/generate`, {
      ...
      body: JSON.stringify({
        ...
        expiry: 5,
        length: 6,
        messagetemplate: `Your ${OTP_SENDER_ID} verification code is: %OTPCODE%. It expires in %EXPIRY% minutes. Don't share this code with anyone. If you did not request this code, please ignore this message.`,
        type: "NUMERIC",
