// Test SMS with username as sender ID
...
async function testSmsWithUsernameAsSender() {
  const testPhone = '233241234567';
  const testMessage = 'Test message from FeeFlow';
  const senderId = USERNAME; // Use username as sender ID
  
  console.log(`\n🧪 Testing SMS with username as Sender ID: ${senderId}`);
